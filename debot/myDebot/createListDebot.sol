...
contract createListDebot is initListDebot {

    // function start() public override {
    //     Terminal.input(tvm.functionId(),"Please enter your public key",false);
    // }
    ...
    function newPurchase(uint32 index) public {
        index = index;
        Terminal.input(tvm.functionId(createPurchase_), "One line please:", false);
    }

    function createPurchase_(string purchaseName, uint number) public view {
        optional(uint256) pubkey = 0;
        iTodo(m_address).newPurchase{
                abiVer: 2,
                extMsg: true,
                sign: true,
                pubkey: pubkey,
